...
- (void)sendRecordWithError:(NSError*)error
{
    if (!error) {
        //可以发送，发送完成之后需要隐藏
        if (self.completion) {
