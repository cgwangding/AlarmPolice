...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.userNameTF.text = default_get_Object(@"curPhone");
    self.userPwdTF.text = @"";
...
- (void)login
{
    ...
    [APIManager loginWithParams:params success:^(NSDictionary *dict) {
        ...
        default_add_Object(strongSelf.userNameTF.text, @"curPhone");
        default_synchronize;
//         [APService setTags:[NSSet setWithObject:UUID] callbackSelector:@selector(tagsAliasCallback:tags:alias:) object:strongSelf];
        [APService setAlias:[UUID substringToIndex:15] callbackSelector:@selector(tagsAliasCallback:tags:alias:) object:strongSelf];
