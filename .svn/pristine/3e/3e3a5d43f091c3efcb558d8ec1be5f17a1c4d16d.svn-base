...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 0) {
        ...
        [cell1.headerImgView sd_setImageWithURL:[NSURL URLWithString:[user.headerURL stringByTrimmingCharactersInSet:[NSCharacterSet characterSetWithCharactersInString:@","]]] placeholderImage:[UIImage imageNamed:@"header_default"]];
